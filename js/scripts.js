...
const QUESTIONS = {
    ...
    science: [
      ...
      { category: 'Ciencia', question: '¿Cuál es el metal más ligero?', options: ['Litio', 'Aluminio', 'Plomo', 'Cobre'], answer: 'Litio' },
      {
        category: 'Ciencia',
      ...
      { category: 'Ciencia', question: '¿Qué tipo de sangre es el donante universal?', options: ['O-', 'A+', 'B-', 'AB+'], answer: 'O-' },
      {
        category: 'Ciencia',
      ...
      { category: 'Ciencia', question: '¿Cuál es el símbolo químico del hierro?', options: ['Fe', 'Ir', 'In', 'I'], answer: 'Fe' },
      {
        category: 'Ciencia',
    ...
    art: [
      ...
      },
      {
        ...
        options: ['Frida Kahlo', 'Georgia O’Keeffe', 'Tamara de Lempicka', 'Artemisia Gentileschi'],
        answer: 'Frida Kahlo'
      },
      {
        category: 'Arte',
    ...
    general: [
      { category: 'Cultura General', question: '¿Cuántos planetas tiene el sistema solar?', options: ['8', '9', '7', '10'], answer: '8' },
      {
      ...
      { category: 'Cultura General', question: '¿Cuántos lados tiene un hexágono?', options: ['6', '5', '8', '7'], answer: '6' },
      {
        category: 'Cultura General',
      ...
      { category: 'Cultura General', question: '¿Cuántos anillos hay en la bandera olímpica?', options: ['5', '4', '6', '7'], answer: '5' },
      {
        category: 'Cultura General',
    ...
    mythology: [
      ...
      {
        category: 'Mitología',
        question: '¿Qué bestia custodiaba la entrada al inframundo en la mitología griega?',
      ...
      { category: 'Mitología', question: '¿Qué héroe mató a Medusa?', options: ['Perseo', 'Hércules', 'Teseo', 'Aquiles'], answer: 'Perseo' },
      {
        category: 'Mitología',
