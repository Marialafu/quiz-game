...
const QUESTIONS = {
    history: [
      {
        category: 'history',
        question: '¿Qué faraón egipcio fue enterrado en el Valle de los Reyes y descubierto en 1922?',
      ...
      },
      {
        ...
        options: ['Muro de Berlín', 'Muro de los Lamentos', 'Muro de Adriano', 'Muro de Tracia'],
        answer: 'Muro de Berlín'
      },
      {
        category: 'history',
        question: '¿Qué ciudad fue arrasada por los griegos durante la guerra de Troya?',
      ...
      {
        category: 'history',
        question: '¿Qué conflicto se libró entre el norte y el sur de EE.UU. en el siglo XIX?',
        options: ['Guerra Civil Americana', 'Guerra de Independencia', 'Guerra de Vietnam', 'Guerra de Corea'],
        answer: 'Guerra Civil Americana'
      },
      {
        category: 'history',
        question: '¿En qué año se firmó la Declaración de Independencia de EE. UU.?',
      ...
      },
      {
        ...
        options: ['Imperio Ming', 'Imperio Romano', 'Imperio Persa', 'Imperio Bizantino'],
        answer: 'Imperio Ming'
      },
      {
        category: 'history',
      ...
      {
        category: 'history',
        question: '¿Dónde nació Napoleón Bonapart?',
      ...
      },
      {
        ...
        options: ['Guerra de las Dos Rosas', 'Guerra de los Cien Años', 'Guerra de Independencia', 'Guerra de Sucesión'],
      ...
      },
      {
        ...
        options: ['Cristóbal Colón', 'Américo Vespucio', 'Hernán Cortés', 'Marco Polo'],
      ...
      {
        category: 'history',
        question: '¿Qué país fue liderado por Winston Churchill durante la Segunda Guerra Mundial?',
    ...
    science: [
      {
        ...
        options: ['Alexander Fleming', 'Marie Curie', 'Isaac Newton', 'Charles Darwin'],
        answer: 'Alexander Fleming'
      },
      {
        category: 'science',
        question: '¿Cómo se llama el proceso por el cual las plantas producen su alimento?',
      ...
      {
        category: 'science',
        question: '¿Qué part del cuerpo humano bombea sangre?',
      ...
      {
        category: 'science',
        question: '¿Cuál es el segundo elemento más abundante en el aire después del nitrógeno?',
      ...
      { category: 'science', question: '¿Cuál es el metal más ligero?', options: ['Litio', 'Aluminio', 'Plomo', 'Cobre'], answer: 'Litio' },
      {
        category: 'science',
      ...
      {
        category: 'science',
        question: '¿Qué unidad se usa para medir la intensidad de la corriente eléctrica?',
      ...
      { category: 'science', question: '¿Qué tipo de sangre es el donante universal?', options: ['O-', 'A+', 'B-', 'AB+'], answer: 'O-' },
      {
        category: 'science',
      ...
      {
        category: 'science',
        question: '¿Qué part de la célula contiene el material genético?',
        options: ['Núcleo', 'Citoplasma', 'Membrana', 'Mitocondria'],
        answer: 'Núcleo'
      },
      { category: 'science', question: '¿Cuál es el símbolo químico del hierro?', options: ['Fe', 'Ir', 'In', 'I'], answer: 'Fe' },
      {
        category: 'science',
      ...
      },
      {
        ...
        options: ['La Luna', 'Mart', 'Europa', 'Titán'],
        answer: 'La Luna'
      },
      {
        category: 'science',
      ...
      },
      {
        ...
        options: ['Teoría de la evolución', 'Teoría de la relatividad', 'Teoría celular', 'Teoría del Big Bang'],
    ...
    geography: [
      ...
      },
      {
        ...
        options: ['Mar de Filipinas', 'Mar Caribe', 'Mar Mediterráneo', 'Mar de China Meridional'],
      ...
      {
        category: 'geography',
        question: '¿Cuál es el lago más grande de agua dulce del mundo por superficie?',
    ...
    art: [
      ...
      {
        category: 'art',
        question: '¿Qué edificio es famoso por su cúpula diseñada por Brunelleschi?',
        options: ['Catedral de Florencia', 'Basílica de San Pedro', 'Notre-Dame', 'Catedral de Santiago'],
      ...
      },
      {
        ...
        options: ['Frida Kahlo', 'Leonora Carrington', 'Remedios Varo', 'María Izquierdo'],
        answer: 'Frida Kahlo'
      },
      {
        category: 'art',
      ...
      },
      {
        ...
        options: ['Expresionismo abstracto', 'Cubismo', 'Surrealismo', 'Realismo'],
      ...
      },
      {
        ...
        options: ['Vincent van Gogh', 'Leonardo da Vinci', 'Paul Cézanne', 'Henri Matisse'],
      ...
      {
        category: 'art',
        question: '¿Qué técnica artística utiliza pigmentos disueltos en agua sobre yeso fresco?',
      ...
      },
      {
        ...
        options: ['Auguste Rodin', 'Donatello', 'Miguel Ángel', 'Gian Lorenzo Bernini'],
        answer: 'Auguste Rodin'
      },
      {
        category: 'art',
        question: '¿Qué edificio contiene la Capilla Sixtina?',
        options: ['El Vaticano', 'Notre Dame', 'La Sagrada Familia', 'El Palacio de Versalles'],
        answer: 'El Vaticano'
      },
      {
        category: 'art',
      ...
      {
        category: 'art',
        question: '¿Qué pintor usó mayormente el color azul en su famosa "época azul"?',
        options: ['Pablo Picasso', 'Henri Matisse', 'Joan Miró', 'Marc Chagall'],
        answer: 'Pablo Picasso'
      },
      {
        category: 'art',
        question: '¿Qué estilo arquitectónico caracteriza a las catedrales medievales con arcos puntiagudos y vitrales?',
        options: ['Gótico', 'Románico', 'Barroco', 'Renacentista'],
        answer: 'Gótico'
      },
      {
        category: 'art',
        question: '¿Qué pintora es famosa por sus autorretratos intensamente personales?',
        options: ['Frida Kahlo', 'Georgia O’Keeffe', 'Tamara de Lempicka', 'artmisia Gentileschi'],
        answer: 'Frida Kahlo'
      },
      {
        category: 'art',
        question: '¿Qué artista es conocido por sus enormes latas de sopa Campbell?',
        options: ['Andy Warhol', 'Roy Lichtenstein', 'Keith Haring', 'Jean-Michel Basquiat'],
        answer: 'Andy Warhol'
      }
    ],
    general: [
      { category: 'general', question: '¿Cuántos planetas tiene el sistema solar?', options: ['8', '9', '7', '10'], answer: '8' },
      {
        category: 'general',
        question: '¿Qué día se celebra Halloween?',
        options: ['31 de octubre', '1 de noviembre', '30 de septiembre', '2 de noviembre'],
      ...
      { category: 'general', question: '¿Cuántos lados tiene un hexágono?', options: ['6', '5', '8', '7'], answer: '6' },
      {
        category: 'general',
      ...
      },
      {
        ...
        options: ['Gabriel García Márquez', 'Mario Vargas Llosa', 'Isabel Allende', 'Pablo Neruda'],
      ...
      {
        category: 'general',
        question: '¿Qué part del cuerpo controla el cerebro?',
        options: ['Todo el cuerpo', 'Los brazos', 'La digestión', 'La respiración únicamente'],
        answer: 'Todo el cuerpo'
      },
      { category: 'general', question: '¿Cuántos anillos hay en la bandera olímpica?', options: ['5', '4', '6', '7'], answer: '5' },
      {
        category: 'general',
      ...
      },
      {
        ...
        options: ['Harry Potter', 'Las Crónicas de Narnia', 'El Señor de los Anillos', 'Percy Jackson'],
        answer: 'Harry Potter'
      },
      {
        category: 'general',
      ...
      },
      {
        ...
        options: ['La Luna', 'Mart', 'Europa', 'Saturno'],
        answer: 'La Luna'
      },
      {
        category: 'general',
    ...
    mythology: [
      ...
      {
        category: 'mythology',
        question: '¿Qué bestia custodiaba la entrada al inframundo en la mythology griega?',
      ...
      {
        category: 'mythology',
        question: '¿Qué criatura mitológica tiene cuerpo de león, cabeza humana y alas?',
      ...
      { category: 'mythology', question: '¿Qué héroe mató a Medusa?', options: ['Perseo', 'Hércules', 'Teseo', 'Aquiles'], answer: 'Perseo' },
      {
        category: 'mythology',
      ...
      },
      {
        ...
        options: ['Atenea', 'Afrodita', 'artmisa', 'Deméter'],
        answer: 'Atenea'
      },
      {
        category: 'mythology',
        question: '¿Qué dios romano es equivalente a Zeus?',
        options: ['Júpiter', 'Mart', 'Neptuno', 'Plutón'],
        answer: 'Júpiter'
      }
    ]
  };
